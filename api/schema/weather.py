class WeatherReport():
    def __init__(self, day, city, lat, lon, temperature_daily_min, temperature_daily_max, rel_humidity_daily_avg, max_temperature, min_temperature, max_rel_humidity, min_rel_humidity, mean_rel_humidity, precipitation_daily_acu, precipitation_daily_max, precipitation_daily_min, metaWeather):
        self.city = city
        self.lat = lat
        self.lon = lon
        self.day = day
